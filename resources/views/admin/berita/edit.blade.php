...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <!-- Form -->
    <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" id="form-update-berita">
        @csrf
        @method('PUT')
    ...
    <div class="mt-6">
        <div class="bg-red-50 border border-red-200 rounded-xl p-6">
            ...
            <form id="delete-form-{{ $berita->id }}" action="{{ route('admin.berita.destroy', $berita->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <button type="button" onclick="openDeleteModal('delete-form-{{ $berita->id }}', 'Apakah Anda yakin ingin menghapus berita &quot;{{ addslashes($berita->judul) }}&quot;? Tindakan ini tidak dapat dibatalkan.')" class="w-full flex items-center justify-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm font-medium">
