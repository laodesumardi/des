            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex flex-col items-center">
                        ...
                        @if($logoPath)
                        <form action="{{ route('admin.settings.delete-logo') }}" method="POST" class="w-full mt-2" onsubmit="return confirm('Yakin ingin menghapus logo?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full px-4 py-2 bg-red-50 text-red-600 rounded-xl text-sm font-medium hover:bg-red-100 transition-colors">
                                Hapus Logo
                            </button>
                        </form>
                        @endif
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex flex-col items-center">
                        ...
                        @if($faviconPath)
                        <form action="{{ route('admin.settings.delete-favicon') }}" method="POST" class="w-full mt-2" onsubmit="return confirm('Yakin ingin menghapus favicon?')">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full px-4 py-2 bg-red-50 text-red-600 rounded-xl text-sm font-medium hover:bg-red-100 transition-colors">
                                Hapus Favicon
