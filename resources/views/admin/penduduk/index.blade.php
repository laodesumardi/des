                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <form id="delete-form-{{ $p->id }}" action="{{ route('admin.penduduk.destroy', $p->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" onclick="openDeleteModal('delete-form-{{ $p->id }}', 'Apakah Anda yakin ingin menghapus data penduduk &quot;{{ addslashes($p->nama) }}&quot;? Tindakan ini tidak dapat dibatalkan.')" class="p-1.5 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded" title="Hapus">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
