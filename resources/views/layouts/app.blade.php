        ...
        <div class="container mx-auto px-4 py-8 md:py-12 relative z-10">
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <div class="logo-animate px-4 py-3 md:px-5 md:py-4 flex items-center justify-center overflow-hidden">
                    @if($logoPath)
                    <img src="{{ asset('images/' . $logoPath) }}?v={{ time() }}" alt="{{ $headerNamaDesa }}" class="w-20 h-20 md:w-24 md:h-24 object-contain">
                    @else
                    <svg class="w-20 h-20 md:w-24 md:h-24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <div class="p-2 overflow-hidden">
                            @if($logoPath)
                            <img src="{{ asset('images/' . $logoPath) }}?v={{ time() }}" alt="{{ $headerNamaDesa }}" class="w-10 h-10 object-contain">
                            @else
