        ...
        <div class="container mx-auto px-4 py-8 md:py-12 relative z-10">
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <div class="logo-animate px-4 py-3 md:px-5 md:py-4 flex items-center justify-center overflow-hidden">
                    @if($logoPath)
                    <img src="{{ asset('images/' . $logoPath) }}?v={{ time() }}" alt="{{ $headerNamaDesa }}" class="w-24 h-24 md:w-28 md:h-28 object-contain">
                    @else
                    <svg class="w-24 h-24 md:w-28 md:h-28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <div class="p-2 overflow-hidden">
                            @if($logoPath)
                            <img src="{{ asset('images/' . $logoPath) }}?v={{ time() }}" alt="{{ $headerNamaDesa }}" class="w-12 h-12 object-contain">
                            @else
